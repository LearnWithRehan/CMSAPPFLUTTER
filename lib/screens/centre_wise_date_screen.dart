...
class CentreWiseDateScreen extends StatefulWidget {
  const CentreWiseDateScreen({super.key});

  @override
  State<CentreWiseDateScreen> createState() => _CentreWiseDateScreenState();
}

class _CentreWiseDateScreenState extends State<CentreWiseDateScreen> {
  ...
  Future<void> onProcess() async {
    final sp = await SharedPreferences.getInstance();
    await sp.setString("SELECTED_DATE_CENTRE", formattedDate);

    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (_) => const CentreWiseReportScreen(),
      ),
    );
  }
