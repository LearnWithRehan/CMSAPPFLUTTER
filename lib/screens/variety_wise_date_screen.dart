...
class VarietyWiseDateScreen extends StatefulWidget {
  ...
  @override
  State<VarietyWiseDateScreen> createState() =>
      _VarietyWiseDateScreenState();
}

class _VarietyWiseDateScreenState extends State<VarietyWiseDateScreen> {
  ...
  Future<void> onProcess() async {
    final sp = await SharedPreferences.getInstance();
    await sp.setString("SELECTED_DATEVAR", formattedDate);

    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (_) => const VarietyWiseReportScreen(),
      ),
    );
  }
